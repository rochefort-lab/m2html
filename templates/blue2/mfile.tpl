...
<!--<table width="100%"><tr><td align="left"><a href="{MASTERPATH}{INDEX}"><img alt="<" border="0" src="{MASTERPATH}html_img/left.png">&nbsp;Master index</a></td>
<td align="right"><a href="{INDEX}">Index for {MDIR}&nbsp;<img alt=">" border="0" src="{MASTERPATH}html_img/right.png"></a></td></tr></table>-->

<h1>{NAME}
<!-- BEGIN mexfile --> &nbsp;&nbsp;<img src="{MASTERPATH}html_img/{MEXTYPE}.png" alt="{PLATFORMS}" border="0" title="{PLATFORMS}"> <!-- END mexfile -->
</h1>

<h2><a name="_name"></a>PURPOSE <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}html_img/up.png"></a></h2>
<div class="box"><strong>{H1LINE}</strong></div>

<h2><a name="_synopsis"></a>SYNOPSIS <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}html_img/up.png"></a></h2>
